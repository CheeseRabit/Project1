...
void print_in_pre_order_bst_node(BSTNodePtr self) {
	if (self != NULL) {
		printf(" %d ", self->data_item);
		print_in_pre_order_bst_node(self->left);
		print_in_pre_order_bst_node(self->right);
	}
}

void print_in_pre_order_bst(BST* self) {
	print_in_pre_order_bst_node(self->root);
}

void print_in_post_order_bst_node(BSTNodePtr self) {
	if (self != NULL) {
		print_in_post_order_bst_node(self->left);
		print_in_post_order_bst_node(self->right);
		printf(" %d ", self->data_item);
	}
}

void print_in_post_order_bst(BST* self) {
	print_in_post_order_bst_node(self->root);
}
...
int height_node(BSTNodePtr self) {
	if (self == NULL) {
		...
		int height_left = height_node(self->left);
		int height_right = height_node(self->right);
...
void bst_test() {
	...
	printf("\npre:\n");
	print_in_pre_order_bst(&tree);
	printf("\npost:\n");
	print_in_post_order_bst(&tree);
	printf("\nheight:\n");
